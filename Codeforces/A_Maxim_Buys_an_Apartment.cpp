...
int main()
{
    ...
    else
    {
    	...
    	if(n%3==0)
    	{
    		if(x==k)cout << x*2 << endl;
    		if(x<k)cout << x*2-(k-x) << endl;
    		if(x>k)cout << x*2-(x-k)*2 << endl;
    	}
    	if(n%3==1)
    	{   
    		if(x==k)cout << x*2 << endl;
    		if(x<k)cout << 1+x*2-(k-x) << endl;
    		if(x>k)cout << x*2-(x-k)*2 << endl;
    	}
    	if(n%3==2)
    	{
    		...
    		x=x*2+1;
    		if(y==k)cout << x << endl;
    		if(y<k)cout << x-(k-y) << endl;
    		if(y>k)cout << k*2 << endl;
    	}
    }
