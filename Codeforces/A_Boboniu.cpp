...
int main()
{
    fastio;
    T{
    	int a,b,c,d,i,x,cnt=1;
    	cin >>a>>b>>c>>d;
 
    	x=min(a,min(b,min(c,5)));
    	for(i=0; i<=x; i++)
    	{
    		if(i)a-=1,b-=1,c-=1;
    		d+=i*3;
    		if((a%2==0&&b%2==0&&c%2==0)or(b%2==0&&c%2==0&&d%2==0)or(c%2==0&&d%2==0&&a%2==0)or(d%2==0&&a%2==0&&b%2==0))
    	    {
    		    cnt=0;
    		    Yes();
    		    break;
    	    }
    	    else if((a%2==0&&b%2==0&&d%2==0)or(a%2==0&&c%2==0&&d%2==0))
    	    {
    	    	cnt=0;
    	    	Yes();
    		    break;
