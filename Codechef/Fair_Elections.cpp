...
int main()
{
    ...
    T{
    	...
    	else
    	{
    		...
    		if(x>y)
    		{
                v[2].pb(0),v[2].pb(abs(x-y));
                v[3].pb(abs(x-y)),v[3].pb(0);
    		}
    		else
    		{
                v[2].pb(abs(x-y)),v[2].pb(0);
                v[3].pb(0),v[3].pb(abs(x-y));
    		}
    		if(k%4==0)cout << v[3][0] <<" "<< v[3][1] << endl;
    		else cout << v[(k%4)-1][0] <<" "<< v[(k%4)-1][1] << endl;
    		v[0].clear();
    		v[1].clear();
    		v[2].clear();
    		v[3].clear();
